...
- Single timeline: every agent's tool call, file op, shell exec, prompt,
  response
- Per-agent attribution: `[example] Bash: git log --oneline` or `[content_agent / sub:ab3c99fc] WebFetch: https://…`
...
09:52:48  claude-code  tool_call      [example] Bash: git log -5 · 12ms
09:52:43  claude-code  tool_call      [example] Edit: src/ui/App.tsx · 7ms
09:51:51  claude-code  tool_call      [example] Agent: Competitive landscape 2026 ▸ 52 child events
...
The full, ticket-level roadmap lives in the [Linear project](https://linear.app/example/project/agentwatch-748d6aa1c20a).
Headlines:
