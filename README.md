...
[Linear project](https://linear.app/example/project/agentwatch-748d6aa1c20a).
...
- **Semantic session search** ([AUR-181](https://linear.app/example/issue/AUR-181)) — local `transformers.js` + `sqlite-vec` + BM25 hybrid. ~3-4 days of work.
- **Cursor SQLite adapter** ([AUR-187](https://linear.app/example/issue/AUR-187)) — thin best-effort read of workspaceStorage/*.vscdb.
