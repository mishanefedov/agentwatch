...
`example` monorepo. Tests are failing. You want to know: which agent
...
1. Launch: `agentwatch`
2. `P` → projects grid
3. Select `example`, `Enter`
4. Sessions list for example, bucketed by date
...
- Breadcrumb at top: `agentwatch · example · session ab3c99 · search "src/auth"`
